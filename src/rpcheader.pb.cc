...
void protobuf_AssignDesc_rpcheader_2eproto() {
  ...
  static const int RpcHeader_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RpcHeader, paramsize_),
  };
...
void protobuf_AddDesc_rpcheader_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\tparamSize\030\003 \001(\rb\006proto3", 105);
...
const int RpcHeader::kParamSizeFieldNumber;
...
void RpcHeader::SerializeWithCachedSizes(
  ...
  // optional uint32 paramSize = 3;
  if (this->paramsize() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(3, this->paramsize(), output);
  }
...
::google::protobuf::uint8* RpcHeader::InternalSerializeWithCachedSizesToArray(
  ...
  // optional uint32 paramSize = 3;
  if (this->paramsize() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(3, this->paramsize(), target);
  }
...
// optional uint32 paramSize = 3;
void RpcHeader::clear_paramsize() {
  paramsize_ = 0u;
}
 ::google::protobuf::uint32 RpcHeader::paramsize() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.paramSize)
  return paramsize_;
}
 void RpcHeader::set_paramsize(::google::protobuf::uint32 value) {
