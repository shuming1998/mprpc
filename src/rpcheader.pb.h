...
class RpcHeader : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mprpc.RpcHeader) */ {
 public:
  ...
  ::google::protobuf::uint32 paramsize() const;
  void set_paramsize(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 paramsize_;
...
inline ::google::protobuf::uint32 RpcHeader::paramsize() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.paramSize)
  return paramsize_;
}
inline void RpcHeader::set_paramsize(::google::protobuf::uint32 value) {
